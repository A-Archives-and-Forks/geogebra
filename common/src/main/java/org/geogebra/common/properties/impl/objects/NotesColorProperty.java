...
import org.geogebra.common.properties.impl.objects.delegate.NotesColorPropertyDelegate;

public class NotesColorProperty extends ElementColorProperty {
	 ...
	 */
	public NotesColorProperty(Localization localization,
			GeoElement element) throws NotApplicablePropertyException {
		super(localization, new NotesColorPropertyDelegate(element));
	}
