...
public enum Language {
	 ...
	 */
	final public static Language fromLanguageTagOrLocaleString(String langCode) {
		if (langCode == null) {
			return English_US;
		}
	...
	/**
	 * @param gwtLocaleString GWT locale string (see values in {@link Language#toLanguageTag()}.
	...
	final public static String getCurrency(String gwtLocaleString) {
		return fromLanguageTagOrLocaleString(gwtLocaleString).currency;
	}
