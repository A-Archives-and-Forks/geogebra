...
public class RequiresBracketsTest extends BaseUnitTest {
	...
	public void testFunctionMinusFunction() {
		...
		lookup("eq1").setToStringMode(EquationForm.Linear.USER);
	...
	public void testFunctionsTimesFunction() {
		...
		lookup("eq0").setToStringMode(EquationForm.Quadric.USER);
		lookup("eq1").setToStringMode(EquationForm.Quadric.USER);
		lookup("eq2").setToStringMode(EquationForm.Quadric.USER);
		lookup("eq3").setToStringMode(EquationForm.Quadric.USER);
