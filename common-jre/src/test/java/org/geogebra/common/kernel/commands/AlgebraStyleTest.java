...
public class AlgebraStyleTest extends BaseUnitTest {
	...
	public void checkEquationExplicit() {
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.EXPLICIT,
				"x^2 + 4y^2 = 1");
		checkEquation("x^2+4*y^2-y+x*y=x +x -1", EquationForm.Quadric.EXPLICIT,
				"x^2 + x y + 4y^2 - 2x - y = -1");
		checkEquation("-x^2=x +x -1", EquationForm.Quadric.EXPLICIT,
				"-x^2 - 2x = -1");
	}
	...
	public void checkEquationVertex() {
		...
		checkNonParabolaFallback(EquationForm.Quadric.VERTEX);
		// three actual parabolas
		checkEquation("-x^2=x +x -1+y", EquationForm.Quadric.VERTEX,
				"y = -(x + 1)^2 +2");
		checkEquation("x^2=x +x -1+y", EquationForm.Quadric.VERTEX,
				"y = (x - 1)^2");
		checkEquation("y^2=y +y -1+x", EquationForm.Quadric.VERTEX,
				"(x - 0) = (y - 1)^2");
	}
	...
	public void checkEquationSpecific() {
		// ellipse
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.SPECIFIC,
				"x^2 / 1 + y^2 / 0.25 = 1");
		// hyperbola
		checkEquation("x^2-4*y^2=2x+2y+1", EquationForm.Quadric.SPECIFIC,
				"(x - 1)^2 / 1.75 - (y + 0.25)^2 / 0.44 = 1");
		// double line
		checkEquation("-x^2=x +x -1", EquationForm.Quadric.SPECIFIC,
				"(-x - 2.41) (-x + 0.41) = 0");
		// parabolas
		checkEquation("-x^2-x=x -1+y", EquationForm.Quadric.SPECIFIC,
				"x^2 = -2x - y + 1");
		checkEquation("y^2=x +x -1+y", EquationForm.Quadric.SPECIFIC,
				"y^2 = 2x + y - 1");
		checkEquation("(x+y)^2=x +x -1+y", EquationForm.Quadric.SPECIFIC,
				"x^2 + 2x y + y^2 - 2x - y = -1");
	}

	@Test
	public void checkEquationConicform() {
		checkNonParabolaFallback(EquationForm.Quadric.CONICFORM);
		// parabolas
		checkEquation("-x^2-x=x -1+y", EquationForm.Quadric.CONICFORM,
				"-(y - 2) = (x + 1)^2");
		checkEquation("y^2=x +x -1+y", EquationForm.Quadric.CONICFORM,
				"2(x - 0.38) = (y - 0.5)^2");
		checkEquation("(x+y)^2=x +x -1+y", EquationForm.Quadric.CONICFORM,
				"x^2 + 2x y + y^2 - 2x - y = -1");
	}
	...
	public void checkEquationParametric() {
		// ellipse
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.PARAMETRIC,
				"X = (0, 0) + (cos(t), 0.5 sin(t))");
		// hyperbola
		checkEquation("x^2-4*y^2=2x+2y+1", EquationForm.Quadric.PARAMETRIC,
				"X = (1, -0.25) + (" + Unicode.PLUSMINUS
						+ " 1.32 cosh(t), 0.66 sinh(t))");
		// parallel lines
		checkEquation("-x^2=x +x -1", EquationForm.Quadric.PARAMETRIC,
		...
		// parabolas
		checkEquation("-x^2-x=x -1+y", EquationForm.Quadric.PARAMETRIC,
				"X = (-1, 2) + (-0.5 t, -0.25 t^2)");
		checkEquation("y^2=x +x -1+y", EquationForm.Quadric.PARAMETRIC,
				"X = (0.38, 0.5) + (0.5 t^2, t)");
		checkEquation("(x+y)^2=x +x -1+y", EquationForm.Quadric.PARAMETRIC,
	...
	public void checkEquationImplicit() {
		// ellipse
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.IMPLICIT,
				"x^2 + 4y^2 = 1");
		// hyperbola
		checkEquation("x^2-4*y^2=2x+2y+1", EquationForm.Quadric.IMPLICIT,
				"x^2 - 4y^2 - 2x - 2y = 1");
		// parallel lines
		checkEquation("-x^2=x +x -1", EquationForm.Quadric.IMPLICIT,
				"-x^2 - 2x = -1");
		// double line
		checkEquation("-x^2=x +x +1", EquationForm.Quadric.IMPLICIT,
				"-x^2 - 2x = 1");
		// parabolas
		checkEquation("-x^2-x=x -1+y", EquationForm.Quadric.IMPLICIT,
				"-x^2 - 2x - y = -1");
		checkEquation("y^2=x +x -1+y", EquationForm.Quadric.IMPLICIT,
				"y^2 - 2x - y = -1");
		checkEquation("(x+y)^2=x +x -1+y", EquationForm.Quadric.IMPLICIT,
				"x^2 + 2x y + y^2 - 2x - y = -1");
	}

	@Test
	public void checkEquationReload() {
		checkEquationReload("x^2+4*y^2=1", EquationForm.Quadric.EXPLICIT,
				"x^2 + 4y^2 = 1");
		checkEquationReload("-x^2=x +x -1+y", EquationForm.Quadric.VERTEX,
				"y = -(x + 1)^2 +2");
		checkEquationReload("x^2+4*y^2=1", EquationForm.Quadric.SPECIFIC,
				"x^2 / 1 + y^2 / 0.25 = 1");
		checkEquationReload("-x^2-x=x -1+y", EquationForm.Quadric.CONICFORM,
				"-(y - 2) = (x + 1)^2");
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.PARAMETRIC,
				"X = (0, 0) + (cos(t), 0.5 sin(t))");
		checkEquation("x^2+4*y^2=1", EquationForm.Quadric.IMPLICIT,
